...
data["District"]=data["District"].str.replace("район ", "").astype("category")#замена слова "район" на пусто
data["AdmArea"]=data["AdmArea"].apply(lambda x:x.split(" ")[0]).astype("category")#в округах оставляем первое слово
